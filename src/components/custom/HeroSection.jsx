        ...
        <section className="z-5">
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                ...
                >
                    ...
                    <svg
                        className="ml-2 w-5 h-5 transition-transform duration-300 hover:rotate-180"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                ...
                <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                    ...
                    >
                        Get Started
                        <svg
                            className="ml-2 -mr-1 w-5 h-5 transition-transform duration-300 hover:translate-x-1"
                            fill="currentColor"
                            viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg"
                        >
                    ...
                    >
                        <svg
                            className="mr-2 -ml-1 w-5 h-5 transition-transform duration-300 hover:rotate-45"
                            fill="currentColor"
                            viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg"
                        >
                ...
                <div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
                    ...
                    <div className="flex flex-wrap justify-center items-center mt-8 text-gray-500 sm:justify-between">
                        <a
                            href="https://www.linkedin.com/in/zahidraimoon/"
                            className="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400 transition-transform duration-300 hover:scale-110"
                        >
                            {/* LinkedIn SVG */}
                        </a>
                        <a
