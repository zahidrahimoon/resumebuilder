...
const HowItWorks = () => {
  return (
    ...
    <section className="py-8 z-50 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
      <h2 className="font-bold text-3xl transition-transform duration-300 hover:scale-105">How it Works?</h2>
      <p className="text-md text-gray-500 transition-transform duration-300 hover:scale-105">Give mock interviews in just 3 simple steps</p>
